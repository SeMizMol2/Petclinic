...
const operationsItems = [
  ...
  { to: '/admin/receipts', icon: 'receipt', label: 'ใบเสร็จชำระเงิน', description: 'ออกบิล ติดตามการชำระ และพิมพ์เอกสาร' },
...
const pageMeta = {
  ...
  '/admin/receipts': ['ใบเสร็จชำระเงิน', 'จัดการการออกใบเสร็จ การชำระเงิน และการพิมพ์เอกสาร'],
