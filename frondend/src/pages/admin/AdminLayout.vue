    ...
    <aside class="w-72 bg-slate-900 text-white flex flex-col shadow-2xl z-20">
      <div class="p-6 border-b border-slate-800 flex items-center gap-4">
        ...
        <div>
          ...
          <p class="text-xs text-slate-400 mt-1">Pet Clinic Management</p>
        </div>
      </div>
      ...
      <nav class="flex-1 px-4 py-8 space-y-2 overflow-y-auto custom-scrollbar">
        ...
        <router-link to="/admin/reports" class="nav-item" active-class="active">
          <span class="icon">Rpt</span>
          <span class="label">รายงานสรุป</span>
        </router-link>
      </nav>
